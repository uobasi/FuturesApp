...
currSymbolNameList = ['6AH4','6BH4','6CH4', '6EH4', '6JH4', '6SH4','6NH4']
currSymbolNumList = ['156755', '156618', '1545', '156627', '156657','156650', '2259']
...
def update_graph_live(n_intervals, data):
    ...
    if stkName in symbolNameList: 
        ...
        fg = plotChart(df, [hs[1],ntList[:86]], va[0], va[1], [], [], bigOrders=[], optionOrderList=[], stockName=currSymbolNameList[currSymbolNumList.index(symbolNum)], previousDay=False, prevdtstr='', pea=False, sord = [], OptionTimeFrame = timeFrame, overall=[]) #trends=FindTrends(df,n=10)
